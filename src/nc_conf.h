...
//
#define CONF_CHANGE_ADD		1
#define CONF_CHANGE_DEL	    2
#define CONF_CHANGE_MOD		3
...
struct conf_pool {
	...
	int				   slow_req_duration;	  /* slow_req_duration: */
...
rstatus_t conf_pool_master(void *elem, void *data);
