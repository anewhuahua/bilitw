...
void event_loop_stats_ext(event_stats_cb_t cb, void *arg);


int event_add_channel(struct event_base *evb, nc_channel_msg_t* message);
int event_del_channel(struct event_base *evb, nc_channel_msg_t* message);
